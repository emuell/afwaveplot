...
pub mod multi_channel {
    ...
    ///
    /// See [`super::mixed_down::waveform_from_buffer`] for more info about the `resolution` parameter.
...
#[cfg(test)]
mod tests {
    use super::mixed_down::waveform_from_buffer as waveform_from_buffer_mixed_down;
    use super::multi_channel::waveform_from_buffer as waveform_from_buffer_multi_channel;
    ...
    fn waveform() {
        ...
        // downscale
        let mono_downscale_result = waveform_from_buffer_mixed_down(
            &long_file_buffer,
        ...
        // upscale
        let mono_upscale_result = waveform_from_buffer_mixed_down(
            &small_file_buffer,
        ...
        // downscale
        let downscale_result = waveform_from_buffer_multi_channel(
            &long_file_buffer,
            long_file_specs.channels as usize,
            long_file_specs.sample_rate,
            1024,
        ...
        // upscale
        let upscale_result = waveform_from_buffer_multi_channel(
            &small_file_buffer,
            small_file_specs.channels as usize,
            small_file_specs.sample_rate,
            1024,
